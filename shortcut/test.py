...
class TestDrawing(unittest.TestCase):
    ...
    def test_find_file_paths(self):
        ...
        actual = self.drawing.find_file_paths()
        self.assertEqual(expect, actual)
...
class TestPO(unittest.TestCase):
    ...
    def test_find_folder_paths(self):
        ...
        actual = self.po.find_folder_paths()
        self.assertEqual(expect, actual)
    ...
    def test_find_file_paths(self):
        expect = (
            ...
            r'\PO_0060000.PDF')
        actual = self.po.find_file_paths()
        self.assertEqual(expect, actual)
...
class TestJobcard(unittest.TestCase):
    ...
    def test_find_folder_paths(self):
        ...
        actual = self.jc.find_folder_paths()
        self.assertEqual(expect, actual)
    ...
    def test_find_file_paths(self):
        ...
        actual = self.jc.find_file_paths()
        self.assertEqual(expect, actual)
